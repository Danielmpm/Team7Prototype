...
(function (GameFromScratch) {
    var StartMenu = (function (_super) {
        ...
        StartMenu.prototype.createSpySprite = function (dark, posX, posY) {
            var sprite;
            if (dark)
        ...
        StartMenu.prototype.createGuardSprite = function (dark, posX, posY) {
            var sprite;
            if (dark)
        ...
        StartMenu.prototype.nextEvent = function () {
            this.currentEvent++;
            this.mainTimer = 0;
        ...
        StartMenu.prototype.updateMainAnimation = function () {
            switch (this.currentEvent) {
                case 0:
        ...
        StartMenu.prototype.updateInsertCoin = function () {
